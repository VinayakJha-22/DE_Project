...
document.getElementById('buy-now-a').addEventListener('click', function() {
    document.getElementById('product-a').scrollIntoView({ behavior: 'smooth' });
    event_buy_now = true
  });
...
document.getElementById('auth-a').addEventListener('click', function() {
    event_auth = true
    document.getElementById('auth-a').innerText = "Hi"
  });
